...
import 'dart:isolate';
import 'package:sellerkit/DBModel/authorization_db.dart';
import 'package:sellerkit/DBModel/daystarttable_model.dart';
import 'package:sellerkit/DBModel/sitecheckintable_model.dart';
...
import 'package:sellerkit/DBModel/leadopendb_model.dart';
...
import '../DBModel/screenshot_model.dart';
...
class DBHelper {
  ...
  static void createTable(Database database, int version) async {
    ...
    await database.execute(
        ...
        await database.execute(
        '''
           create table $tablevisitplanfilter(
             ETId integer primary key autoincrement,
             ${tableVisitplanCulumns.visitplan} int ,
             ${tableVisitplanCulumns.customercode} varchar ,
             ${tableVisitplanCulumns.purposeofvisit} varchar ,
             ${tableVisitplanCulumns.meetingtime} varchar ,
             ${tableVisitplanCulumns.userid} int ,
             ${tableVisitplanCulumns.closed} varchar ,
             ${tableVisitplanCulumns.customername} varchar ,
             ${tableVisitplanCulumns.address1} varchar ,
             ${tableVisitplanCulumns.address2} varchar ,
             ${tableVisitplanCulumns.address3} varchar ,
             ${tableVisitplanCulumns.city} varchar ,
             ${tableVisitplanCulumns.product} varchar ,
            
             ${tableVisitplanCulumns.pincode} varchar ,
             ${tableVisitplanCulumns.state} varchar ,
             ${tableVisitplanCulumns.cusmobile} varchar ,
             ${tableVisitplanCulumns.cusemail} varchar ,
             ${tableVisitplanCulumns.contactname} varchar ,
             ${tableVisitplanCulumns.area} varchar ,
             ${tableVisitplanCulumns.district} varchar ,
             ${tableVisitplanCulumns.country} varchar ,
             ${tableVisitplanCulumns.storecode} varchar ,
             ${tableVisitplanCulumns.plannedDate} varchar ,
             ${tableVisitplanCulumns.checkinDateTime} varchar ,
             ${tableVisitplanCulumns.checkinLat} decimal ,
             ${tableVisitplanCulumns.checkinLong} decimal ,
             ${tableVisitplanCulumns.checkoutDateTime} varchar ,
             ${tableVisitplanCulumns.checkoutLat} decimal ,
             ${tableVisitplanCulumns.checkoutLong} decimal ,
             ${tableVisitplanCulumns.lookingFor} varchar ,
             ${tableVisitplanCulumns.assignedTo} varchar ,
             ${tableVisitplanCulumns.visitOutcome} varchar ,
             ${tableVisitplanCulumns.potentialBusinessValue} decimal ,
             ${tableVisitplanCulumns.visitStatus} varchar ,
             ${tableVisitplanCulumns.isClosed} varchar ,
             ${tableVisitplanCulumns.baseType} int ,
             ${tableVisitplanCulumns.baseId} int ,
             ${tableVisitplanCulumns.targetType} varchar ,
             ${tableVisitplanCulumns.targetId} varchar ,
             ${tableVisitplanCulumns.att1} varchar ,
             ${tableVisitplanCulumns.att2} varchar ,
             ${tableVisitplanCulumns.att3} varchar ,
             ${tableVisitplanCulumns.att4} varchar ,
             ${tableVisitplanCulumns.createdBy} int ,
             ${tableVisitplanCulumns.createdDateTime} varchar ,
             ${tableVisitplanCulumns.updatedBy} int ,
             ${tableVisitplanCulumns.updatedDateTime} varchar ,
             ${tableVisitplanCulumns.traceid} varchar 
            
             )
        ''');
         await database.execute(
        '''
           create table $tablesiteinfilter(
             ETId integer primary key autoincrement,
             ${tablesiteinCulumns.visitplan} int ,
             ${tablesiteinCulumns.customercode} varchar ,
             ${tablesiteinCulumns.purposeofvisit} varchar ,
             ${tablesiteinCulumns.meetingtime} varchar ,
             ${tablesiteinCulumns.userid} int ,
             ${tablesiteinCulumns.closed} varchar ,
             ${tablesiteinCulumns.customername} varchar ,
             ${tablesiteinCulumns.address1} varchar ,
             ${tablesiteinCulumns.address2} varchar ,
             ${tablesiteinCulumns.address3} varchar ,
             ${tablesiteinCulumns.city} varchar ,
             ${tablesiteinCulumns.product} varchar ,
             ${tablesiteinCulumns.pincode} varchar ,
             ${tablesiteinCulumns.state} varchar ,
             ${tablesiteinCulumns.cusmobile} varchar ,
             ${tablesiteinCulumns.cusemail} varchar ,
             ${tablesiteinCulumns.contactname} varchar ,
             ${tablesiteinCulumns.area} varchar ,
             ${tablesiteinCulumns.district} varchar ,
             ${tablesiteinCulumns.country} varchar ,
             ${tablesiteinCulumns.storecode} varchar ,
             ${tablesiteinCulumns.plannedDate} varchar ,
             ${tablesiteinCulumns.checkinDateTime} varchar ,
             ${tablesiteinCulumns.checkinLat} decimal ,
             ${tablesiteinCulumns.checkinLong} decimal ,
             ${tablesiteinCulumns.checkoutDateTime} varchar ,
             ${tablesiteinCulumns.checkoutLat} decimal ,
             ${tablesiteinCulumns.checkoutLong} decimal ,
             ${tablesiteinCulumns.lookingFor} varchar ,
             ${tablesiteinCulumns.assignedTo} varchar ,
             ${tablesiteinCulumns.visitOutcome} varchar ,
             ${tablesiteinCulumns.potentialBusinessValue} decimal ,
             ${tablesiteinCulumns.visitStatus} varchar ,
             ${tablesiteinCulumns.isClosed} varchar ,
             ${tablesiteinCulumns.baseType} int ,
             ${tablesiteinCulumns.baseId} int ,
             ${tablesiteinCulumns.targetType} varchar ,
             ${tablesiteinCulumns.targetId} varchar ,
             ${tablesiteinCulumns.att1} varchar ,
             ${tablesiteinCulumns.att2} varchar ,
             ${tablesiteinCulumns.att3} varchar ,
             ${tablesiteinCulumns.att4} varchar ,
             ${tablesiteinCulumns.createdBy} int ,
             ${tablesiteinCulumns.createdDateTime} varchar ,
             ${tablesiteinCulumns.updatedBy} int ,
             ${tablesiteinCulumns.updatedDateTime} varchar ,
             ${tablesiteinCulumns.traceid} varchar 
