...
class ItemMasterNewData {
 ...
 required this. storeAgeSlab2,
  ...
  String? allowOrderBelowCost;
  String? isFixedPrice;
  String? validTill;
  String? color;
  String? calcType;
  String? payOn;
  String? storeAgeSlab1;
  String? storeAgeSlab2;
  String? storeAgeSlab3;
  String? storeAgeSlab4;
  String? storeAgeSlab5;
  String? whsAgeSlab1;
  String? whsAgeSlab2;
  String? whsAgeSlab3;
  String? whsAgeSlab4;
  ...
  factory ItemMasterNewData.fromJson(Map<String, dynamic> json) {
    ...
    return ItemMasterNewData(
        ...
        movingType: json['MovingType']??'',
        partCode: json['PartCode']??'',
        priceStockId: json['PriceStockId']??'',
        ...
        calcType: json['CalcType']??'',
   payOn: json['PayOn']??'',
     storeAgeSlab1: json['Store_Age_Slab_1']??'',
   storeAgeSlab2: json['Store_Age_Slab_2']??'',
   storeAgeSlab3: json['Store_Age_Slab_3']??'',
   storeAgeSlab4: json['Store_Age_Slab_4']??'',
   storeAgeSlab5: json['Store_Age_Slab_5']??'',
   whsAgeSlab1: json['Whs_Age_Slab_1']??'',
   whsAgeSlab2: json['Whs_Age_Slab_2']??'',
   whsAgeSlab3: json['Whs_Age_Slab_3']??'',
   whsAgeSlab4: json['Whs_Age_Slab_4']??'',
   whsAgeSlab5: json['Whs_Age_Slab_5']??'',
        );
  }
