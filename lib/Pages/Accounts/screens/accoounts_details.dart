...
final int? i;
  @override
  State<AccountsDetailspage> createState() => AccountsDetailspageState();
}
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              width:
                                                  Screens.width(context) * 0.4,
                                              child: Text(
                                                  '${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].CustomerName}',
                                                  style: theme
                                            ...
                                            InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                width: Screens.width(context) *
                                                    0.4,
                                                child: Text(
                                                    '${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].CustomerCode}',
                                                    style: theme
                                                        .textTheme.bodyMedium
                                                        ?.copyWith(
                                                            color: Colors.blue,
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                              'GSTIN:${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].GSTNo == null ? "" : context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].GSTNo}',
                                              style: theme.textTheme.bodyMedium
                                                  ?.copyWith(
                                                color: Colors.grey,
                                                // decoration: TextDecoration
                                        ...
                                        //       width: Screens.width(context) * 0.4,
                                        //       child: Text(
                                        //           '${context.watch<AccountsContoller>().getAccountsDataFilter[i??0!].Bil_City}',
                                        //           style: theme.textTheme.bodyMedium
                                        //               ?.copyWith(
                                        //             color: theme.primaryColor,
                                        //             //fontWeight: FontWeight.bold
                                  ...
                                  Container(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(
                                          "${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].CustomerName![0].toString().toUpperCase()}${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].CustomerName![1].toString().toUpperCase()}",
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                context
                                        .watch<AccountsContoller>()
                                        .getAccountsDataFilter[widget.i!]
                                        .Bil_Address1!
                                        .isEmpty
                                    ? Text("")
                                    : Text(
                                        '${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].Bil_Address1},${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].Bil_Address2}, ${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].Bil_City}, ${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].Bil_State}-${context.watch<AccountsContoller>().getAccountsDataFilter[widget.i!].Bil_Pincode}',
                                        style: theme.textTheme.bodyMedium!
                                            .copyWith(
                                                color: theme.primaryColor))
                              ],
                            ...
                            children: [
                              Container(
                                ...
                                child: ElevatedButton(
                                    onPressed: () {
                                      //  log("CAREEE"+context.watch<AccountsContoller>().getAccountsDataFilter[i??0!].cardcode.toString());
