...
import 'newvisit_controller.dart';
...
//           context.read<NewEnqController>().selectUser(ind);
  ...
  mapvaluesfromLead(BuildContext context) async {
    ...
    await setdefaultUserName();
    notifyListeners();
    mycontroller[1].text = datafromlead[0];
    mycontroller[0].text = datafromlead[1];
    mycontroller[3].text = datafromlead[2] == null ||
            datafromlead[2] == "null" ||
            datafromlead[2].isEmpty
        ? ""
        : datafromlead[2];
    mycontroller[4].text = datafromlead[3] == null ||
            datafromlead[3] == "null" ||
            datafromlead[3].isEmpty
        ? ""
        : datafromlead[3];
    mycontroller[5].text = datafromlead[10] == null ||
            datafromlead[10] == "null" ||
            datafromlead[10].isEmpty
        ? ""
        : datafromlead[10];
    mycontroller[6].text = datafromlead[5] == null ||
            datafromlead[5] == "null" ||
            datafromlead[5].isEmpty
        ? ""
        : datafromlead[5];
    mycontroller[7].text = datafromlead[4] == null ||
            datafromlead[4] == "null" ||
            datafromlead[4].isEmpty
        ? ""
        : datafromlead[4];
    mycontroller[8].text = datafromlead[8] == null ||
            datafromlead[8] == "null" ||
            datafromlead[8].isEmpty
        ? ""
        : datafromlead[8];
    mycontroller[17].text = datafromlead[7] == null ||
            datafromlead[7] == "null" ||
            ...
            if (value.itemdata!.enquirydetails != null &&
              ...
              for (int i = 0; i < value.itemdata!.enquirydetails!.length; i++) {
                if (value.itemdata!.enquirydetails![i].DocType == "Lead") {
                  ...
                  log("enquirydetails::" +
                      enquirydetails!.length.toString()); // }
                }
              }
...
//   }
  ...
  iscateSeleted(BuildContext context, String select, String code) {
    ...
    if (purposecode == '05' || purposecode == '06') {
      ...
      if (purposecode == '05' &&
          enquirydetails != null &&
          enquirydetails.isNotEmpty) {
        callenquirydetails(enquirydetails![0], context);
        Navigator.pop(context);
        notifyListeners();
      } else if (purposecode == '06' &&
          leaddetails != null &&
...
//         } else {
  ...
  validateSchedule(BuildContext context) async {
    if (formkey.currentState!.validate()) {
      if (statecode.isEmpty && countrycode.isEmpty) {
      ...
      } else if (mycontroller[10].text.isEmpty ||
          mycontroller[11].text.isEmpty) {
        errorTime = '';
        islodingtime = true;
        notifyListeners();
      } else {
        ...
        if (iscomeforupdate == true) {
          ...
          postvistdata.pincode = mycontroller[7].text.isEmpty
              ? 0
              : int.parse(mycontroller[7].text);
          ...
          postvistdata.potential =
              potentialvalue == null ? null : potentialvalue;
