...
import 'package:sellerkit/Models/CustomerMasterModel/customermaster_model.dart';
...
onvisiblefeature(int indexfromList){
  if(allProductDetails[indexfromList].isselected == 0){
allProductDetails[indexfromList].isselected = 1;
notifyListeners();
  }else{
    
allProductDetails[indexfromList].isselected = 0;
notifyListeners();
  }
  notifyListeners();
}
   ...
   if (Particularprice.length <= 5) ...[
     ...
     const SizedBox(height: 5),
      ...
      Container(), // Fallback if none of the conditions are met
                   ...
                   ConstantValues.showallslab!.toLowerCase() !='y'?Container():  const   SizedBox(
                        height: 5,
                      ),
                      ...
                      Row(
                        children: [
                         ...
                         const SizedBox(
                          ...
                          //     textOn :"Warehouse",
                          //     textOff: "Store",
                          //     colorOff:theme.primaryColor.withOpacity(0.2),
                          //     textOffColor:theme.primaryColor,
                          //     colorOn: theme.primaryColor,
                          //     textOnColor: Colors.white,
                          //     onDoubleTap: (){},
                          //     iconOff : Icons.check,
                          //      iconOn :Icons.add_home,
                          //     onChanged: (val){
                          //       st((){
                          //         isselected2=value;
