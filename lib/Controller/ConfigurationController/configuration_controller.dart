...
import '../../DBModel/authorization_db.dart';
...
String brandview='';
  Future<void> checkBeforeLoginApi(BuildContext context) async {
    ...
    print("checktenet2::"+tenet2.toString());
    await checkPlatFrom();
...
// Url.queryApi = 'http://91.203.133.224:81/api/';
  ...
  model=await  Config.getdeviceModel() ;
      ...
      print("getdeviceModel::"+e.toString());

    }
    try{
  brand=await  Config.getdeviceBrand() ;
    }catch(e){
 print("getdeviceBrand::"+e.toString());
    }
