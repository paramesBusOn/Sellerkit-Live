...
import 'package:sellerkit/Pages/Dashboard/widgets/setup_alertbox.dart';
...
import '../../Models/DashBoardModels/segementwise_model.dart';
import '../../Models/DashBoardModels/targetachievements_model.dart';
...
// log("Profile pic : ${ConstantValues.profilepic}");
  ...
  List<charts.Series<TargetAchievmentModel, String>> createSampleData() {
    final desktopSalesData = [
       TargetAchievmentModel('2014', 5),
       TargetAchievmentModel('2015', 25),
       TargetAchievmentModel('2016', 100),
       TargetAchievmentModel('2017', 75),
    ];

    final tableSalesData = [
       TargetAchievmentModel('2014', 25),
       TargetAchievmentModel('2015', 50),
       TargetAchievmentModel('2016', 10),
       TargetAchievmentModel('2017', 20),
    ];

    return [
       charts.Series<TargetAchievmentModel, String>(
        id: 'Desktop',
  ...
  List<charts.Series<SegmentWiseModel, DateTime>> createSampleData2() {
    final us_data = [
       SegmentWiseModel( DateTime(2017, 9, 19), 5),
       SegmentWiseModel( DateTime(2017, 9, 26), 25),
       SegmentWiseModel( DateTime(2017, 10, 3), 78),
       SegmentWiseModel( DateTime(2017, 10, 10), 54),
    ];

    final uk_data = [
       SegmentWiseModel( DateTime(2017, 9, 19), 15),
       SegmentWiseModel( DateTime(2017, 9, 26), 33),
       SegmentWiseModel( DateTime(2017, 10, 3), 68),
       SegmentWiseModel( DateTime(2017, 10, 10), 48),
    ];

    return [
       charts.Series<SegmentWiseModel, DateTime>(
        id: 'US Sales',
...
notifyListeners();
  ...
  lottiurl='Assets/network-signal.png';
  ...
  callKpiApi() async {
    ...
    await NewKpiApi.sampleDetails().then((value) {
      if (value.stsCode! >= 200 && value.stsCode! <= 210) {
        ...
        kpilottie = 'Assets/network-signal.png';
