...
List<FollowUPListData> fupODueListData2 = [];
  List<FollowUPListData> get getfupListData2 => fupODueListData2;

  List<FollowUPListData> fupUpcmListData2 = [];
  List<FollowUPListData> get getfupUpcmListData2 => fupUpcmListData2;
...
//   bool? get getrequireVisitBool => requireVisitBool;
  ...
  clearData() {
    ...
    fupUpcmListData2.clear();
    fupODueListData2.clear();
    clearbool();
    notifyListeners();
  }
  ...
  mapvaluestoDB(List<GetAllLeadData> leadOpenAllData) async {
    ...
    for (int i = 0; i < leadOpenAllData.length; i++) {
      ...
      if (nextfollowdate2.isAfter(curentdate2)) {
        fupUpcmListData2.add(FollowUPListData(
            ...
            fupUpcmListData2.sort((a,b)=>a.LeadDocNum!.compareTo(b.LeadDocNum!));
fupUpcmListData=fupUpcmListData2;
        // log("fupUpcmListData::" + fupUpcmListData.length.toString());
      } else {
        fupODueListData2.add(FollowUPListData(
            FollowupDate: leadOpenAllData[i].NextFollowup,
            LeadDocEntry: leadOpenAllData[i].LeadDocEntry,
            LeadDocNum: leadOpenAllData[i].LeadNum,
            FollowupEntry: leadOpenAllData[i].FollowupEntry,
            ...
            pincode: leadOpenAllData[i].pincode,
            state: leadOpenAllData[i].state));
 fupODueListData2.sort((a,b)=>a.LeadDocNum!.compareTo(b.LeadDocNum!));
     fupODueListData=fupODueListData2;
