...
final Database db = (await DBHelper.getInstance())!;
    ...
    await DBOperation.onsearchapply(
            db,
            v)
        .then((value) async {
  ...
  List<outstandingLine> outstandline = [];
   List<outstandingDBModel> dupvalueDBmodel = [];
...
//  NewCollectionContoller. comefromoutStanding.add()
  ...
  dupvalueDBmodel   = await DBOperation.getoutstandingMaster(db);
