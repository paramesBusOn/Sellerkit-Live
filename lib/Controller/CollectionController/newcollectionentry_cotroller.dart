...
import '../../Constant/location_track.dart';
import '../../DBHelper/db_helper.dart';
import '../../DBHelper/db_operation.dart';
import '../../DBModel/outstandingdb_model.dart';
import '../../DBModel/outstanding_linechild.dart';
...
import '../OutStandingController/outstanding_controller.dart';
...
mappaymode(List<PaymodeModalData> duplicatepaymode){
  ...
  for(int i=0;i<duplicatepaymode.length;i++){
    if(duplicatepaymode[i]. Applicable_CE ==true){
